...
public final class RefactoringController implements IController{
	...
	private Runnable applyRefactoring() {
		return new Runnable() {				
			...
			@Override
			public void run() {
				org.eclipse.uml2.uml.State selectedEObject = 
					(org.eclipse.uml2.uml.State) dataManagement.
	...
	public final class InternalRefactoringProcessor extends 
		...
		public RefactoringStatus checkInitialConditions(){
				...
				// there is no initial check to do
				return result;
		}
		...
		public RefactoringStatus checkFinalConditions(){
				...
				if (newname.equals("unspecified")) {
					String msg = "Please insert a new name!!!";
					result.addFatalError(msg);
				}
				// TODO further checks follow
				return result;
		}
